...
<div align="center">
  <img src="./assets/architecture.svg" alt="Fechatter 架构图" width="600">
</div>
...
API 网关 (Pingora :8080)
    ↓
核心服务:
├── Fechatter 服务器 (:6688) → PostgreSQL, Redis, Meilisearch, NATS, S3
├── 通知服务器 (:6687) → Redis, NATS
├── 机器人服务器 (:6686) → Redis, OpenAI API
└── 分析服务器 (:6690) → ClickHouse, NATS
