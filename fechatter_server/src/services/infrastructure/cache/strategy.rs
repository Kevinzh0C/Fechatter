...
impl CacheStrategyService {
    ...
    pub fn new_noop() -> Self {
        ...
        let redis_arc: Arc<RedisCacheService> = unsafe {
            std::mem::transmute::<Arc<NoopRedisCacheService>, Arc<RedisCacheService>>(Arc::new(
                noop,
            ))
        };
    ...
    pub async fn invalidate_latest_message_page(
        &self,
        chat_id: i64,
    ) -> Result<(), crate::AppError> {
    ...
    pub async fn cache_message_page_optimized(
        ...
        self.cache_message_page(chat_id, page as u32, messages, is_latest_page)
            .await
    }
