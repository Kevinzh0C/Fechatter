...
impl<T: EventTransport + ?Sized> EventPublisher<T> {
    ...
    E: Serialize + Signable,
  {
    ...
    let headers = if self.sign_headers {
      ...
      let signed_payload = serde_json::to_vec(&event).map_err(|e| {
        AppError::SerializationError(format!("Failed to serialize signed {}: {}", context, e))
      })?;
    ...
    self
      .publish_with_retry(subject, &payload, headers, context)
      .await
  }
  ...
  pub async fn publish_chat_member_joined(
    ...
    self
      .publish_event(subjects::CHAT_MEMBER_JOINED, event, "chat_member_joined")
      .await
  }
  ...
  pub async fn publish_chat_member_left(
    ...
    self
      .publish_event(subjects::CHAT_MEMBER_LEFT, event, "chat_member_left")
      .await
  }
  ...
  pub async fn publish_duplicate_message_attempted(
    ...
    self
      .publish_event(subjects::DUPLICATE_MESSAGE, event, "duplicate_message")
      .await
  }
  ...
  pub async fn publish_search_delete(&self, id: &MessageId) -> Result<(), AppError> {
    ...
    self
      .publish_event(subjects::SEARCH_INDEX, event, "search_delete")
      .await
  }
  ...
  pub async fn publish_search_index(
    ...
    self
      .publish_event(subjects::SEARCH_INDEX, event, "search_index")
      .await
  }
  ...
  pub async fn publish_unified_message_created(
    ...
    self
      .publish_event(unified_subjects::MESSAGE_CREATED_V1, event, "unified_message_created")
      .await
  }
  ...
  pub async fn publish_unified_message_edited(
    ...
    self
      .publish_event(unified_subjects::MESSAGE_EDITED_V1, event, "unified_message_edited")
      .await
  }
  ...
  pub async fn publish_unified_message_deleted(
    ...
    self
      .publish_event(unified_subjects::MESSAGE_DELETED_V1, event, "unified_message_deleted")
      .await
  }
  ...
  pub async fn publish_unified_chat_member_joined(
    ...
    self
      .publish_event(unified_subjects::CHAT_MEMBER_JOINED_V1, event, "unified_chat_member_joined")
      .await
  }
  ...
  pub async fn publish_unified_chat_member_left(
    ...
    self
      .publish_event(unified_subjects::CHAT_MEMBER_LEFT_V1, event, "unified_chat_member_left")
      .await
  }
  ...
  pub async fn publish_unified_message_read_receipt(
    ...
    self
      .publish_event("fechatter.realtime.message.read_receipt.v1", event, "unified_read_receipt")
      .await
  }
}
