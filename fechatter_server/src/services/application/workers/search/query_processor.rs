...
impl QueryProcessor {
    ...
    pub fn is_stop_word(word: &str) -> bool {
        ...
        static ENGLISH_STOP_WORDS: &[&str] = &[
            ...
            "ought", "i", "you", "he", "she", "it", "we", "they", "me", "him", "her", "us", "them",
            "my", "your", "his", "her", "its", "our", "their", "mine", "yours", "ours", "theirs",
            "this", "that", "these", "those", "here", "there", "where", "when", "why", "how",
            "what", "which", "who", "whom", "whose", "all", "any", "some", "no", "not", "very",
            "so", "too", "more", "most", "much", "many", "few", "little", "less", "up", "down",
    ...
    fn detect_query_intent(
        ...
        static FILE_PATTERNS: &[&str] = &[
            "文件", "图片", "文档", "PDF", "Word", "Excel", "图像", "照片", "file", "image",
            "document", "photo", "picture",
        ];

        // Person-related patterns
        static PERSON_PATTERNS: &[&str] =
            &["@", "发送", "来自", "sent by", "from", "作者", "author"];
...
impl SearchSuggestionGenerator {
    ...
    fn generate_completion_suggestions(partial_query: &str, limit: usize) -> Vec<String> {
        let common_completions = [
            "文件", "图片", "文档", "报告", "会议", "项目", "任务", "计划", "file", "image",
            "document", "report", "meeting", "project", "task", "plan",
        ];
