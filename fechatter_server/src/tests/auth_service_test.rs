...
mod tests {
    ...
    fn create_test_auth_service(
        ...
        let event_publisher = Arc::new(
            crate::services::infrastructure::flows::events::SimplifiedEventPublisher::new(
                Arc::new(crate::services::application::CacheStrategyService::new_simple()),
            ),
        );
    ...
    async fn test_direct_auth_service_implementation() {
        ...
        let _ =
            <AuthService as RefreshTokenService>::refresh_token(&auth_service, "test_token", None)
                .await;
        let _ = <AuthService as LogoutService>::logout(&auth_service, "test_token").await;
        let _ =
            <AuthService as LogoutService>::logout_all(&auth_service, fechatter_core::UserId(1))
                .await;
    ...
    async fn test_server_provider_implementation() {
        ...
        let auth_service =
            <ServiceProvider as ActualAuthServiceProvider>::create_service(&provider);
