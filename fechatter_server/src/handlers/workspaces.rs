...
use crate::services::application::workers::workspace::{
    create_workspace_application_service, InviteUserCommand, UpdateWorkspaceCommand,
};
...
pub async fn add_members_handler(
    ...
    // 3. Create command
    let command =
        crate::services::application::workers::workspace::AddMembersCommand { member_ids };
